...
const CategoryList = () => 
{
    ...
    return (
        <div className="flex flex-col justify-center max-w-full bg-transparent px-4 sm:px-6 lg:px-8 rounded">

            <h1 className="text-2xl font-bold text-center mb-2 text-teal-400">Explore our Arsenal</h1>
